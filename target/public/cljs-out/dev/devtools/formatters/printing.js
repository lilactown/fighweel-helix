...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9633){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9634,G__9635,seq9633__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9639_SHARP_){
return !((cljs.core.meta.call(null,p1__9639_SHARP_) == null));
})))){
...
}catch (e9644){var _e__8593__auto__ = e9644;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e9646){var _e__8593__auto__ = e9646;
return false;
}}
})())){
...
var _STAR_current_state_STAR_9648 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__9649 = opts;
...
var markup_db = cljs.core.get.call(null,map__9649__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_9648;
}});
...
;
var temp__5455__auto___9653 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___9653)){
var managed_print_level_9654 = temp__5455__auto___9653;
var _STAR_print_level_STAR_9652_9655 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_9654;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_9652_9655,managed_print_level_9654,temp__5455__auto___9653,writer,opts,job_fn){
return (function (p1__9651_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9651_SHARP_,null);
});})(_STAR_print_level_STAR_9652_9655,managed_print_level_9654,temp__5455__auto___9653,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_9652_9655;
}} else {
job_fn.call(null);
}
